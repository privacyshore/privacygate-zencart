...
require_once __DIR__ . '/includes/modules/payment/privacygate/autoload.php';
    ...
    public function process()
    {
        ...
        switch ($lastTimeLine['status']) {
            ...
            case 'NEW':
                $this->updateOrderStatus(
                    $orderId,
                    $this->getModuleParam('MODULE_PAYMENT_PENDING_STATUS_ID'),
            ...
            case 'UNRESOLVED':
                ...
                if ($lastTimeLine['context'] === 'OVERPAID') {
                    ...
                    $this->updateOrderStatus(
                        $orderId,
                        $this->getModuleParam('MODULE_PAYMENT_UNRESOLVED_STATUS_ID'),
